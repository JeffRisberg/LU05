...
function PopUp(director_, scene, msg_, image,imageW_, imageH_,buttonsArray,isDirectPopUp) {
  ...
  function addTapCloseButton(con) {
    ...
    tapCloseBG_ = Util.createButtonConWithImageFunWH(director_, "notification", pressDo, con.width + bgShadowSize_+50*sf, con.height + bgShadowSize_, notScaleWhenPressed);
